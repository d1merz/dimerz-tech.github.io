...
**Table of content:**
- [Проблема](#Проблема)
- [Инструменты и ресурсы для решения](#Инструменты-и-ресурсы-для-решения)
- [Concurrency vs Multithreading](#Concurrency-vs-Multithreading)
  - [Multiplexing](#Multiplexing)
- [Асинхронное программирование на примере Tokio](#Асинхронное-программирование-на-примере-Tokio)
  - [В чем идея асинхронности?](#В-чем-идея-асинхронности?)
  - [Futures](#Futures)
  - [Tokio](#Tokio)
    - [Runtime](#Runtime)
