---
layout: post
title: "Linux network API на примере клиент-серверного приложения на Rust"
date: 2023-05-02 20:28:39 +0300
categories: [network, posts, sockets, linux]
---

![client-server](../../images/posts/network/client-server-1.png)
...
Cокет - это абстракция. В данном случае - это интерфейс взаимодействия со стеком TCP/IP, встроенным в ядро. Скажу еще, что приложение должно поддерживать
