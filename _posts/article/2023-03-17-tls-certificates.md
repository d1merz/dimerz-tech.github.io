...
![alt text](../../images/articles/tls-certificates/alice_bob_eva.png)
...
4. Боб, зная только публичный ключ Алисы, поочереди пробует расшифровать оба хеша и только в одном случае ему это удается
...
![alt text](../../images/articles/tls-certificates/cert1.png)
...
![alt text](../../images/articles/tls-certificates/certs_exchange.png)
...
![alt text](../../images/articles/tls-certificates/cert2.png)
